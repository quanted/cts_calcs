	...
	def curate_data(self, metabolites_list):
		...
		for metabolite_obj in metabolites_list:
			...
			if parent not in all_items:
				...
				all_items[parent]['name'] = "<img class='blank_node' src='" + os.getenv("CTS_STATIC_URL") + "cts_app/images/loader_node.gif' />""
			...
			for child_obj in metabolite_obj['products']:
				...
				if child not in all_items:
					...
					all_items[child]['name'] = "<img class='blank_node' src='" + os.getenv("CTS_STATIC_URL") + "cts_app/images/loader_node.gif' />""
